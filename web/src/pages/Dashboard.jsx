...
import { MessagesSquare, Flame, ArrowDownToLine, ArrowUpFromLine } from 'lucide-react';
    ...
    <div>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-5">
        <Card className="p-5 lg:col-span-3">
          <h3 className="mb-4 text-sm font-semibold text-slate-700">Mensajes — últimos 14 días</h3>
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data.daily || []} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="recibidos" name="Recibidos" stroke="#8b5cf6" strokeWidth={2} fill="url(#gIn)" />
