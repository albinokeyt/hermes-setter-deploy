export const STAGES = [
  ...
  { key: 'agendado', label: 'Agendado', dot: 'bg-blue-700', pill: 'bg-blue-600 text-white ring-blue-700', hex: '#1d4ed8', solid: true, desc: 'Reservó una cita en el calendario de GHL. Solo aplica si el objetivo del setter es agendar; lo detecta el sistema.' },
  { key: 'comprador', label: 'Comprador', dot: 'bg-green-600', pill: 'bg-green-600 text-white ring-green-700', hex: '#16a34a', solid: true, desc: 'Pagó un pedido en GHL (formulario de pedido, tienda o factura). Lo detecta el sistema; en la tarjeta ves cuánto y qué compró.' },
  ...
  { key: 'no_asistio', label: 'No asistió', dot: 'bg-rose-500', pill: 'bg-rose-50 text-rose-700 ring-rose-200', hex: '#f43f5e', desc: 'Tenía cita y no se presentó. Ya dijo que sí: se le puede proponer otra hora.' },
