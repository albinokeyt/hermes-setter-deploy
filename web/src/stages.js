export const STAGES = [
  ...
  { key: 'calificado', label: 'Calificado', dot: 'bg-violet-500', pill: 'bg-violet-50 text-violet-700 ring-violet-200', hex: '#8b5cf6', desc: 'Cumple el filtro y mostró interés real; listo para proponerle la cita.' },
  { key: 'seguimiento_calificado', label: 'Seguimiento calificado', dot: 'bg-fuchsia-500', pill: 'bg-fuchsia-50 text-fuchsia-700 ring-fuchsia-200', hex: '#d946ef', desc: 'Estaba calificado pero aún no agendó; el setter le hace seguimiento para que reserve.' },
  { key: 'en_conversion', label: 'En conversión', dot: 'bg-emerald-500', pill: 'bg-emerald-50 text-emerald-700 ring-emerald-200', hex: '#10b981', desc: 'Dio el paso clave: aceptó la propuesta o pidió el enlace de reserva.' },
  { key: 'agendado', label: 'Agendado', dot: 'bg-teal-500', pill: 'bg-teal-50 text-teal-700 ring-teal-200', hex: '#14b8a6', desc: 'Reservó una cita en el calendario de GHL (lo detecta el sistema automáticamente).' },
